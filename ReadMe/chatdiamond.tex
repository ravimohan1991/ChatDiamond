...
for IDE's (Visual Studio for instance) and compiler (MSVC or Clang) use only and therefore c an and should be ignored by a decent version control system\footnote{Actually this is the
...
With enough convincing we are now in a position to understand the organization (or some UT project organization) of this project.  This may serve as a template.  
Consider the hierarcy \ref{forest:project_hierar}.
