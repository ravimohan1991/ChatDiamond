...
// Note from OldUnreal to future generations:
// If you set bAlwaysRelevant to true on an Inventory or Weapon object,
// then its nativereplication properties (except for bHidden) will only
// get replicated once. Script replication properties _will_ get replicated
// even if bAlwaysRelevant is true. 
...
var const array<actor,4>  Touching;      // List of touching actors.
var private const int     Unused;
...
var const bool bNetViewingOwner;  // OldUnreal: The player's viewtarget owns this actor.
...
replication
{
	...
	// OldUnreal: as of v469c, bNetOwner and Inventory also replicate if bNetViewingOwner==true
...
native(1718) final function bool AddToPackageMap( optional string PackageName );
native(1719) final function bool IsInPackageMap( optional string PackageName, optional bool bServerPackagesOnly );
