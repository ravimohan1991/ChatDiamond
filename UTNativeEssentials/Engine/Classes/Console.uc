...
var globalconfig int HistoryTop, HistoryBot, HistoryCur;
var globalconfig string History[16];
var string TypedStr;
		...
		else if( Key==IK_Enter )
		{
			...
			else
			{
				if( TypedStr!="" )
				{
					...
					if (History[(MaxHistory + HistoryCur - 1) % MaxHistory] == TypedStr) HistoryCur--;
